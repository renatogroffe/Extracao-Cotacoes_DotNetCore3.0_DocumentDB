...
namespace CargaCotacoes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var cotacaoMoeda in cotacoesMoedasEstrangeiras)
                cotacoesContext
                    .IncluirCotacao(cotacaoMoeda);
            cotacoesContext
                .IncluirCotacao(cotacaoBitcoin);

            Console.WriteLine("Carga de cotações realizada no DocumentDB...");
        }
    }
}